...
document.addEventListener('DOMContentLoaded', function () {
    ...
    for (i = 0; i < genericExamples.length; ++i) {
        ...
        new Choices(element, {
            ...
            searchPlaceholderValue: 'این قسمت جستجو هست',
        });
    }
    ...
    var singleNoSearch = new Choices('#choices-single-no-search', {
        ...
        choices: [
            { value: 'One', label: 'لیبل یک' },
            { value: 'Two', label: 'لیبل دو', disabled: true },
            { value: 'Three', label: 'لیبل سه' },
        ],
    }).setChoices(
        [
            { value: 'Four', label: 'لیبل چهار', disabled: true },
            { value: 'Five', label: 'لیبل پنج' },
            { value: 'Six', label: 'لیبل شش', selected: true },
        ],
        'value',
        'label',
        false
