            ...
            <div id="sidebar-menu">
                ...
                <div class="sidebar-alert text-center mx-5 my-12">
                    <div class="card-body bg-primary rounded bg-violet-50/50 dark:bg-zinc-700/60">
                        ...
                        <div class="mt-4">
                            <h5 class="text-violet-500 mb-3 font-medium">دسترسی نامحدود</h5>
                            <p class="text-slate-600 text-13 dark:text-gray-50">طرح خود را از طریق یک آزمایش رایگان ارتقا دهید، تا 'طرح تجاری' را انتخاب کنید.</p>
                            <a href="#!" class="btn bg-violet-500 text-white border-transparent mt-6">هم‌اکنون ارتقا دهید</a>
                        </div>
                    </div>
                ...
                <div class="container-fluid px-[0.625rem]">
                    <div class="grid grid-cols-1 mb-5">
                        <div class="flex items-center justify-between">
                            <h4 class="mb-sm-0 text-lg font-semibold grow text-gray-800 dark:text-gray-100">پروفایل</h4>
                                ...
                                <ol class="inline-flex items-center space-x-1 ltr:md:space-x-3 rtl:md:space-x-0">
                                    ...
                                    <li>
                                        <div class="flex items-center">
                                            ...
                                            <a href="#" class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-500 hover:text-gray-900 ltr:md:ml-2 rtl:md:mr-2 dark:text-gray-100 dark:hover:text-white">پروفایل</a>
                                        </div>
                                    </li>
                                </ol>
                            </nav>
                       ...
                       <div class="col-span-12 lg:col-span-9">
                            <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                                <div class="card-body ">
                                    <div class="grid grid-cols-12 ">
                                        <div class="col-span-9">
                                            <div class="flex flex-wrap items-center">
                                                ...
                                                <div>
                                                    <h5 class="text-16 mb-1 text-gray-700 dark:text-gray-100 mr-1">فیلیس گتلین</h5>
                                                    <p class="text-gray-500 dark:text-zinc-100 text-13 mr-1.5">توسعه دهنده تمام صفحه</p>
                            
                                                    <div class="flex flex-wrap items-start gap-2 text-13 mt-3">
                                                        <div class="text-gray-500 dark:text-zinc-100"><i class="mdi mdi-circle-medium me-1 text-green-500 align-middle ltr:mr-1 rtl:ml-1"></i>توسعه</div>
                                        ...
                                        <div class="col-span-3">
                                            <div class="flex flex-wrap justify-end">
                                                <button type="button" class="btn bg-gray-50/50 border-transparent dark:bg-zinc-700 dark:text-gray-100"><i class="me-1"></i> پیام</button>
                                                <div class="dropend text-end relative">
                                                    ...
                                                    <ul class=" dropdown-menu min-w-max absolute bg-white z-50 float-left py-2 list-none text-left -left-9 top-6 w-40
                                                        ...
                                                        <li><a class="dropdown-item text-sm py-2 px-4 font-normal block w-full whitespace-nowrap
                                                            bg-transparent text-gray-700 dark:text-gray-100 hover:bg-gray-50/50 dark:hover:bg-zinc-600/50" href="#">عمل دیگری</a >
                                                        </li>
                                                        <li><a class="dropdown-item text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent
                                                            text-gray-700 dark:text-gray-100 hover:bg-gray-50/50 dark:hover:bg-zinc-600/50" href="#">چیز دیگری اینجا</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <ul class="flex border-t border-gray-50 mt-5 pt-5 dark:border-zinc-600" id="pills-tab" role="tablist">
                                        <li>
                                            <a class="py-5 px-3 active text-violet-500 border-violet-300 border-b-2 dark:border-violet-500 font-medium " data-bs-toggle="tab" href="#overview" role="tab" aria-selected="true">مرور</a>
                                        </li>
                                        <li>
                                            <a class="py-5 px-3 font-medium text-gray-700 dark:text-gray-100" data-bs-toggle="tab" href="#about" role="tab" aria-selected="false" tabindex="-1">درباره</a>
                                        </li>
                                        <li>
                                            <a class="py-5 px-3 font-medium text-gray-700 dark:text-gray-100" data-bs-toggle="tab" href="#post" role="tab" aria-selected="false" tabindex="-1">پست</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                                <div class="card-body border-b border-gray-50 dark:border-zinc-600">
                                    <h5 class="text-15 text-gray-700 dark:text-gray-100">درباره</h5>
                                </div>
                                <div class="card-body">
                                    <div>
                                        <div class="pb-3">
                                            <div class="grid grid-cols-12">
                                                <div class="col-span-2">
                                                    <div>
                                                        <h5 class="text-15 text-gray-700 dark:text-gray-100">بیوگرافی :</h5>
                                                    </div>
                                                </div>
                                                <div class="col-span-10">
                                                    <div class="text-gray-500 dark:text-zinc-100">
                                                        <p class="mb-2">سلام، من فیلیس گتلین هستم، متن فرضی به سادگی صنعت چاپ و صفحه آرایی است. متن فرضی از این کارخانه استاندارد متن است، از زمان 1500 میلادی، هنگامی که یک چاپگر ناشناخته یک چاپخانه از نوع خود را برداشت و آن را برای ساختن یک کتاب نمونه استفاده کرد. این باقی مانده است نه تنها پنج قرن، بلکه با باقی مانده اساساً تغییر نکرده است. آن در دهه 1960 با انتشار صفحات Letraset شامل گذراهای Lorem Ipsum محبوب شد</p>
                                                        <p class="mb-0">این واقعیت ماندگار است که خواننده به دیگر خواننده از محتوای خواندنی صفحه منحرف می شود هنگامی که به آن نگاه می کند که دارای توزیع معمولی حروف است</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="py-3">
                                            <div class="grid grid-cols-12">
                                                <div class="col-span-2">
                                                    <div>
                                                        <h5 class="text-15 text-gray-700 dark:text-gray-100">تجربه کاری :</h5>
                                                    </div>
                                                </div>
                                                <div class="col-span-10">
                                                    <div class="text-gray-500 dark:text-zinc-100">
                                                        <p>اگر چندین زبان ادغام شوند، دستور زبان نتیجه ی زبان نهایی ساده تر و منظم تر از آنچه در هر زبان فردی است، خواهد بود. زبان مشترک جدید ساده تر و منظم تر از زبان های اروپایی موجود خواهد بود. این به انگلیسی به سادگی به نظر خواهد رسید، در واقع، انگلیسی به سادگی ساده شده است، همانطور که دوست مخصوص من در کمبریج به من گفت چیزی که Occidental است. زبان های اروپایی اعضای یک خانواده یکسان هستند. وجود جداگانه آنها یک افسانه است. برای علم، موسیقی، ورزش، و غیره</p>
                            
                                                        <ul class="list-unstyled mb-0 text-gray-500 dark:text-zinc-100 mt-4">
                                                            <li class="py-1"><i class="mdi mdi-circle-medium ltr:mr-1 rtl:ml-1 text-green-500 align-middle"></i>تا خرد زندگی برای رهایی گلوی زهرآگین</li>
                                                            <li class="py-1"><i class="mdi mdi-circle-medium ltr:mr-1 rtl:ml-1 text-green-500 align-middle"></i>همه آرایش برنزی دارند</li>
                                                            <li class="py-1"><i class="mdi mdi-circle-medium ltr:mr-1 rtl:ml-1 text-green-500 align-middle"></i>او به یک کل قبل از یک سازنده نیاز دارد</li>
                                                            <li class="py-1"><i class="mdi mdi-circle-medium ltr:mr-1 rtl:ml-1 text-green-500 align-middle"></i>من حتی در قایق نیستم</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
