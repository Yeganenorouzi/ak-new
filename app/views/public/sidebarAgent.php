    ...
    <div id="sidebar-menu">
      ...
      <ul class="metismenu" id="side-menu">
        ...
        <li>
          ...
          <ul>
            <li>
              <a href="<?php echo URLROOT . "/tickets/agent" ?>" class="pr-14 pl-4 py-2 block text-sm font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">لیست تیکت ها </a>
            </li>
            <li>
