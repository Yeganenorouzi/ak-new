    ...
    <div id="sidebar-menu">
      ...
      <ul class="metismenu" id="side-menu">
        ...
        <li>
          ...
          <ul>
            <li>
              <a href="login.html" class="pr-14 pl-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">لیست کاربران</a>
            </li>
            <li>
              <a href="register.html" class="pr-14 pl-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">افزودن کاربر جدید </a>
            </li>
