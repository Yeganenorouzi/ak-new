                                    ...
                                    <div class="col-span-12 lg:col-span-6">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea
                                                ...
                                                type="text"
                                                id="example-text-input"
                                                name="address"><?php echo htmlspecialchars($data['reception']->address ?? ''); ?></textarea>
                                ...
                                <div class="col-span-12 lg:col-span-2">
                                    <div class="mb-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="dark:bg-zinc-800 dark:border-zinc-700 w-full rounded border-gray-100 py-2.5 text-sm text-gray-500 focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:text-zinc-100" name="paziresh_status"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input class="w-full rounded border-gray-100 placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:text-zinc-100" type="text" id="activation-date" name="activation_start_date"
                                ...
                                <div class="col-span-12 lg:col-span-4">
                                    <div class="mb-4">
                                        ...
                                        <input
                                            ...
                                            name="file1"
                                            value="<?php echo htmlspecialchars($data['reception']->file1 ?? ''); ?>">
                                        <div class="mt-2">
                                ...
                                <div class="col-span-12 lg:col-span-4">
                                    <div class="mb-4">
                                        ...
                                        <input
                                            ...
                                            name="file2"
                                            value="<?php echo htmlspecialchars($data['reception']->file2 ?? ''); ?>">
                                        <div class="mt-2">
                                ...
                                <div class="col-span-12 lg:col-span-4">
                                    <div class="mb-4">
                                        ...
                                        <input
                                            ...
                                            name="file3"
                                            value="<?php echo htmlspecialchars($data['reception']->file3 ?? ''); ?>">
                                        <div class="mt-2">
