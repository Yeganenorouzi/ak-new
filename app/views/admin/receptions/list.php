                        ...
                        <div class="card-body">
                            <div class="card-body p-0 mb-4">
                                <div
                                    ...
                                    <form action="<?php echo URLROOT; ?>/receptions" method="GET"
                                        class="filter-form w-full max-w-4xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 items-end">
                                        <div class="form-group flex flex-col">
                                            <label for="reception_number"
                                                class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">شماره
                                                پذیرش</label>
                                            <input type="text" id="reception_number" name="reception_number"
                                                value="<?php echo isset($_GET['reception_number']) ? $_GET['reception_number'] : ''; ?>"
                                        ...
                                        <div class="form-group flex flex-col">
                                            <label for="serial"
                                                class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">سریال</label>
                                            <input type="text" id="serial" name="serial"
                                                value="<?php echo isset($_GET['serial']) ? $_GET['serial'] : ''; ?>"
                                                class="w-full h-8 text-xs rounded-md border-gray-300 shadow-sm focus:border-violet-500 focus:ring-violet-500 dark:bg-zinc-700 dark:border-zinc-600 dark:text-white px-2">
                                        </div>
                                        <div class="form-group flex flex-col">
                                            <label for="model"
                                            ...
                                            <input type="text" id="model" name="model"
                                                value="<?php echo isset($_GET['model']) ? $_GET['model'] : ''; ?>"
                                                class="w-full h-8 text-xs rounded-md border-gray-300 shadow-sm focus:border-violet-500 focus:ring-violet-500 dark:bg-zinc-700 dark:border-zinc-600 dark:text-white px-2">
                                        </div>
                                        <div class="form-group flex flex-col">
                                            ...
                                            <input type="text" id="customer_name" name="customer_name"
                                                value="<?php echo isset($_GET['customer_name']) ? $_GET['customer_name'] : ''; ?>"
                                                class="w-full h-8 text-xs rounded-md border-gray-300 shadow-sm focus:border-violet-500 focus:ring-violet-500 dark:bg-zinc-700 dark:border-zinc-600 dark:text-white px-2">
                                        </div>
                                        <div class="form-group flex flex-col">
                                            <label for="codemelli"
                                            ...
                                            <input type="text" id="codemelli" name="codemelli"
                                                value="<?php echo isset($_GET['codemelli']) ? $_GET['codemelli'] : ''; ?>"
                                                class="w-full h-8 text-xs rounded-md border-gray-300 shadow-sm focus:border-violet-500 focus:ring-violet-500 dark:bg-zinc-700 dark:border-zinc-600 dark:text-white px-2">
                                        </div>
                                        <div class="form-group flex flex-col">
                                            <label for="mobile"
                                        ...
                                        <div class="form-group flex flex-col lg:col-span-2">
                                            <label for="status"
                                                class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">وضعیت</label>
                                            <select id="status" name="status"
                                                class="w-full h-8 text-xs rounded-md border-gray-300 shadow-sm focus:border-violet-500 focus:ring-violet-500 dark:bg-zinc-700 dark:border-zinc-600 dark:text-white px-2">
                                                <option value="">همه</option>
                                                <option value="دریافت از دفتر مرکزی" <?php echo (isset($_GET['status']) && $_GET['status'] == 'دریافت از دفتر مرکزی') ? 'selected' : ''; ?>>
                                                    دریافت از دفتر مرکزی</option>
                                                <option value="پذیرش در نمایندگی" <?php echo (isset($_GET['status']) && $_GET['status'] == 'پذیرش در نمایندگی') ? 'selected' : ''; ?>>پذیرش در
                                                    نمایندگی</option>
                                                <option value="ارسال از نمایندگی به دفتر مرکزی" <?php echo (isset($_GET['status']) && $_GET['status'] == 'ارسال از نمایندگی به دفتر مرکزی') ? 'selected' : ''; ?>>ارسال از نمایندگی به دفتر مرکزی
                                                </option>
                                                <option value="در انتظار تکمیل مدارک" <?php echo (isset($_GET['status']) && $_GET['status'] == 'در انتظار تکمیل مدارک') ? 'selected' : ''; ?>>
                                                    در انتظار تکمیل مدارک</option>
                                                <option value="ارسال از دفتر مرکزی به نمایندگی" <?php echo (isset($_GET['status']) && $_GET['status'] == 'ارسال از دفتر مرکزی به نمایندگی') ? 'selected' : ''; ?>>ارسال از دفتر مرکزی به نمایندگی
                                                </option>
                                                <option value="تحویل به مشتری" <?php echo (isset($_GET['status']) && $_GET['status'] == 'تحویل به مشتری') ? 'selected' : ''; ?>>تحویل به
                                                    مشتری</option>
                                                <option value="دریافت از نمایندگی" <?php echo (isset($_GET['status']) && $_GET['status'] == 'دریافت از نمایندگی') ? 'selected' : ''; ?>>دریافت
                                                    از نمایندگی</option>
                                                <option value="در انتظار کارشناسی" <?php echo (isset($_GET['status']) && $_GET['status'] == 'در انتظار کارشناسی') ? 'selected' : ''; ?>>در
                                                    انتظار کارشناسی</option>
                                                <option value="در انتظار قطعه" <?php echo (isset($_GET['status']) && $_GET['status'] == 'در انتظار قطعه') ? 'selected' : ''; ?>>در انتظار
                                                    قطعه</option>
                                                <option value="در حال تعویض" <?php echo (isset($_GET['status']) && $_GET['status'] == 'در حال تعویض') ? 'selected' : ''; ?>>در حال تعویض
                                                </option>
                                                <option value="در حال انجام کار در دفتر مرکزی" <?php echo (isset($_GET['status']) && $_GET['status'] == 'در حال انجام کار در دفتر مرکزی') ? 'selected' : ''; ?>>در حال انجام کار در دفتر مرکزی
                                                </option>
                                                <option value="اتمام تعمیر" <?php echo (isset($_GET['status']) && $_GET['status'] == 'اتمام تعمیر') ? 'selected' : ''; ?>>اتمام تعمیر
                                                </option>
                                                <option value="در انتظار تایید هزینه" <?php echo (isset($_GET['status']) && $_GET['status'] == 'در انتظار تایید هزینه') ? 'selected' : ''; ?>>
                                                    در انتظار تایید هزینه</option>
                                        ...
                                        <div
                                            ...
                                            <a href="<?php echo URLROOT; ?>/export/exportReceptions"
                                                ...
                                                <tr
                                                    ...
                                                    <td class="px-6 py-4">
                                                        <div class="flex flex-row gap-2">
                                                            <a href="<?php echo URLROOT; ?>/receptions/edit/<?php echo $item->id; ?>"
                                                                class="font-medium text-blue-600 dark:text-blue-500 hover:underline">ویرایش</a>
                                                            <a href="<?php echo URLROOT; ?>/receptions/print/<?php echo $item->id; ?>"
                                                                class="font-medium text-green-600 dark:text-green-500 hover:underline">پرینت</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
