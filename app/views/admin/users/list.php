        ...
        <div class="container-fluid px-[0.625rem]">
            <div class="col-span-12">
                <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                    ...
                    <!-- فرم فیلتر -->
                    <div class="card-body pb-0">
                        <form action="<?php echo URLROOT; ?>/users/index" method="GET"
                            class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-2">
                            <div class="form-group">
                                <label for="name"
                                    class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">نام و نام
                                    خانوادگی</label>
                            ...
                            <div class="form-group md:col-span-3 flex justify-end gap-2">
                                <button type="submit"
                                    class="px-3 py-1 text-sm bg-violet-500 text-white rounded-md hover:bg-violet-600 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2">
                                    فیلتر
                                </button>
                                <a href="<?php echo URLROOT; ?>/users/index"
                                    class="px-3 py-1 text-sm bg-gray-500 text-white rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                                    پاک کردن فیلترها
                                </a>
                            </div>
                        </form>
                                        ...
                                        <tr
                                            ...
                                            <td class="px-4 py-4">
                                                <img src="<?php echo URLROOT; ?>/assets/uploads/users/<?php echo $item->avatar; ?>"
                                                    alt="تصویر کاربر" class="w-10 h-10 rounded-full object-cover">
                                            </td>
                                            <th scope="row"
                                            ...
                                            <td class="px-6 py-4">
                                                <a href="<?php echo URLROOT; ?>/users/edit/<?php echo $item->id; ?>"
                                                ...
                                                <a href="<?php echo URLROOT; ?>/users/delete/<?php echo $item->id; ?>"
