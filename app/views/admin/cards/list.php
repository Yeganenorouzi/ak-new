            ...
            <div class="col-span-12 xl:col-span-6">
                <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                    ...
                    <div class="card-header p-4 border-b border-gray-100 dark:border-zinc-600">
                        <h5 class="mb-0 text-lg font-semibold text-gray-900 dark:text-white">فیلتر هوشمند کارت‌های گارانتی</h5>
                    </div>
                        ...
                        <form action="<?php echo URLROOT; ?>/cards/applyFilters" method="POST" class="filter-form">
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                                ...
                                <div class="form-group">
                                    <label for="serial" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">سریال اول دستگاه</label>
                                    <input type="text" id="serial" name="serial" value="<?php echo isset($data['filters']['serial']) ? $data['filters']['serial'] : ''; ?>" 
                                ...
                                <div class="form-group">
                                    <label for="serial2" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">سریال دوم دستگاه</label>
                                    <input type="text" id="serial2" name="serial2" value="<?php echo isset($data['filters']['serial2']) ? $data['filters']['serial2'] : ''; ?>" 
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-violet-500 focus:border-violet-500 dark:bg-zinc-700 dark:border-zinc-600 dark:text-white">
                                </div>
                                
                                <div class="form-group">
                                    <label for="model" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">مدل دستگاه</label>
                                    <input type="text" id="model" name="model" value="<?php echo isset($data['filters']['model']) ? $data['filters']['model'] : ''; ?>" 
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-violet-500 focus:border-violet-500 dark:bg-zinc-700 dark:border-zinc-600 dark:text-white">
                                </div>
                                
                                <div class="form-group">
                                    <label for="company" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">شرکت وارد کننده</label>
                                    <input type="text" id="company" name="company" value="<?php echo isset($data['filters']['company']) ? $data['filters']['company'] : ''; ?>" 
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-violet-500 focus:border-violet-500 dark:bg-zinc-700 dark:border-zinc-600 dark:text-white">
                                </div>
                                
                                <div class="form-group">
                                    <label for="sh_sanad" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">شماره سند</label>
                                    <input type="text" id="sh_sanad" name="sh_sanad" value="<?php echo isset($data['filters']['sh_sanad']) ? $data['filters']['sh_sanad'] : ''; ?>" 
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-violet-500 focus:border-violet-500 dark:bg-zinc-700 dark:border-zinc-600 dark:text-white">
                                </div>
                            ...
                            <div class="flex flex-wrap gap-3 items-center justify-between mt-4">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <a href="<?php echo URLROOT; ?>/cards/index" class="inline-flex items-center px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                                ...
                                <!-- دکمه خروجی اکسل -->
                                <a href="<?php echo URLROOT; ?>/export/exportcards" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
                                        ...
                                        <?php foreach ($data['cards'] as $item): ?>
                                            <tr class="bg-white border-b border-gray-100 hover:bg-gray-50/50 dark:bg-zinc-700 dark:hover:bg-zinc-700/50 dark:border-zinc-600">
                                                ...
                                                <td class="px-6 py-4">
                                                    ...
                                                    <a href="javascript:void(0);" onclick="confirmDelete('<?php echo URLROOT; ?>/cards/delete/<?php echo $item->id; ?>', '<?php echo $item->serial; ?>', '<?php echo $item->model; ?>')" class="font-medium text-red-600 dark:text-red-500 hover:underline">حذف</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
