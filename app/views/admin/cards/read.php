            ...
            <div class="col-span-12 xl:col-span-6">
                <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                    <div class="card-body pb-0">
                        <h6 class="mb-1 text-15 text-gray-700 dark:text-gray-100">لیست کارت گاراتتی ها </h6>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="w-full text-sm text-right text-gray-500">
                                <thead class="text-xs text-gray-700 dark:text-gray-100 uppercase bg-gray-50/50 dark:bg-zinc-700/50">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3">
                                            تاریخ صدور کارت گارانتی </th>
                                        </th>
                                        <th scope="col" class="px-6 py-3">
                                            تاریخ انقضا کارت گارانتی </th>
                                        </th>
                                        <th scope="col" class="px-6 py-3">
                                            عملیات
                                        </th>
                                ...
                                <tbody>
                                    <?php foreach ($data['cards'] as $item): ?>
                                        <tr class="bg-white border-b border-gray-100 hover:bg-gray-50/50 dark:bg-zinc-700 dark:hover:bg-zinc-700/50 dark:border-zinc-600">
                                            ...
                                            <td class="px-6 py-4">
                                                <?php echo $item->sh_sanad; ?>
                                            </td>
                                            <td class="px-6 py-4">
                                                <?php echo $item->start_guarantee ?>
                                            </td>
                                            <td class="px-6 py-4">
                                                <?php echo $item->expite_guarantee ?>
                                            </td>
                                            <td class="px-6 py-4">
