        ...
        <div class="container-fluid px-[0.625rem]">
            ...
            <div class="grid grid-cols-1 mb-5">
                <div class="flex items-center justify-between">
                    <h4 class="mb-sm-0 text-lg font-semibold grow text-gray-800 dark:text-gray-100">تعریف نماینده جدید</h4>
                        ...
                        <ol class="inline-flex items-center space-x-1 ltr:md:space-x-3 rtl:md:space-x-0">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="#" class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-500 hover:text-gray-900 ltr:md:ml-2 rtl:md:mr-2 dark:text-gray-100 dark:hover:text-white">تعریف نماینده جدید</a>
                                </div>
                            </li>
                        </ol>
                    </nav>
            ...
            <div class="grid grid-cols-1">
                <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                    ...
                    <div class="card-body">
                        <form action="<?php echo URLROOT; ?>/users/createAgent" method="POST" enctype="multipart/form-data" class="max-w-2xl">
