        ...
        <div class="container-fluid px-[0.625rem]">
            <div class="col-span-12">
                <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                    ...
                    <!-- فرم فیلتر -->
                    <div class="card-body pb-0">
                        <form action="<?php echo URLROOT; ?>/users/indexAgents" method="GET" class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-2">
                            ...
                            <div class="form-group md:col-span-3 flex justify-end gap-2">
                                ...
                                <a href="<?php echo URLROOT; ?>/users/indexAgents" class="px-3 py-1 text-sm bg-gray-500 text-white rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                                    پاک کردن فیلترها
                                </a>
                            </div>
                        </form>
                                ...
                                <tbody>
                                    <?php foreach ($data['agents'] as $item): ?>
                                        <tr class="bg-white border-b border-gray-100 hover:bg-gray-50/50 dark:bg-zinc-700 dark:hover:bg-zinc-700/50 dark:border-zinc-600">
                                            ...
                                            <td class="px-6 py-4">
                                                <a href="<?php echo URLROOT; ?>/users/editAgent/<?php echo $item->id; ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline ml-2">ویرایش</a>
                                                <a href="<?php echo URLROOT; ?>/users/deleteAgent/<?php echo $item->id; ?>" class="font-medium text-red-600 dark:text-red-500 hover:underline mr-2">حذف</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
