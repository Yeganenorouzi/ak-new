        ...
        <div class="container-fluid px-[0.625rem]">
                        ...
                        <ol class="inline-flex items-center space-x-1 ltr:md:space-x-3 rtl:md:space-x-0">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="#" class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-500 hover:text-gray-900 ltr:md:ml-2 rtl:md:mr-2 dark:text-gray-100 dark:hover:text-white">مشخصات نماینده </a>
                                </div>
                            </li>
                        </ol>
                    </nav>
            ...
            <div class="grid grid-cols-1">
                <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                    ...
                    <div class="card-body">
                        <form action="<?php echo URLROOT; ?>/users/updateAgent/<?php echo $data['agent']->id; ?>" method="POST" enctype="multipart/form-data" class="max-w-2xl">
                                ...
                                <div class="col-span-8 ">
                                    <div class="mb-4">
                                        ...
                                        <input
                                            ...
                                            id="codemelli"
                                            value="<?php echo htmlspecialchars($data['agent']->codemelli ?? ''); ?>">
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <input
                                            ...
                                            id="mobile"
                                            value="<?php echo htmlspecialchars($data['agent']->mobile ?? ''); ?>">
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <input
                                            ...
                                            id="email"
                                            value="<?php echo htmlspecialchars($data['agent']->email ?? ''); ?>">
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <input
                                            ...
                                            id="password"
                                            value="<?php echo htmlspecialchars($data['agent']->password ?? ''); ?>">
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input
                                            ...
                                            id="name"
                                            value="<?php echo htmlspecialchars($data['agent']->name ?? ''); ?>">
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input
                                            ...
                                            type="file"
                                            id="avatar"
                                            value="<?php echo htmlspecialchars($data['agent']->avatar ?? ''); ?>"
                                            accept="image/*"
                                            onchange="previewImage(this);">
                                        <div class="mt-2">
                                            <?php if (!empty($data['agent']->avatar)): ?>
                                                <img id="preview" src="<?php echo URLROOT . '/uploads/users/' . $data['agent']->avatar; ?>"
                                                    alt="تصویر کاربر"
                                                    class="rounded-lg"
                                                    style="width: 150px; height: 150px; object-fit: cover;">
                                            <?php else: ?>
                                                <img id="preview" src="<?php echo URLROOT; ?>/assets/uploads/users/default-avatar.png"
                                                    alt="تصویر پیش‌فرض"
                                                    class="rounded-lg"
                                                    style="width: 150px; height: 150px; object-fit: cover;">
                                            <?php endif; ?>
