                                        ...
                                        <tr
                                            ...
                                            <td class="px-6 py-4">
                                                ...
                                                <a href="javascript:void(0);"
                                                    onclick="confirmDelete('<?php echo URLROOT; ?>/customers/delete/<?php echo $item->id; ?>', '<?php echo $item->name; ?>', '<?php echo $item->codemelli; ?>')"
                                                    class="font-medium text-red-600 dark:text-red-500 hover:underline mr-2">حذف</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
