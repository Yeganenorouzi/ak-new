                    ...
                    <div class="login-container h-screen flex items-center justify-center">
                        ...
                        <div class="login-form-container w-full max-w-md relative z-10">
                            ...
                            <?php if (isset($_GET['error']) && $_GET['error'] === 'not_approved'): ?>
                                <div
                                    class="mb-4 p-4 rounded-lg bg-red-50 border border-red-200 dark:bg-red-900/20 dark:border-red-500/30">
                                    <div class="flex items-center">
                                        <svg class="w-5 h-5 text-red-500 dark:text-red-400 ml-2" fill="currentColor"
                                            viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd"
                                                d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
                                                clip-rule="evenodd"></path>
                                        </svg>
                                        <p class="text-red-600 dark:text-red-400 text-sm">حساب کاربری شما هنوز توسط ادمین
                                            تایید نشده است. لطفاً صبر کنید.</p>
                                    </div>
                                </div>
                            <?php endif; ?>
