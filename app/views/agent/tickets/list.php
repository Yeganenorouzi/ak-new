                        ...
                        <div class="card-body">
                            <div class="card-body p-0 mb-4">
                                <div
                                    ...
                                    <form action="<?php echo URLROOT; ?>/tickets/agent" method="GET"
                ...
                <div
                    ...
                    <div class="flex-1 flex justify-between sm:hidden">
                        <?php if ($data['current_page'] > 1): ?>
                            <a href="<?php echo URLROOT; ?>/tickets/agent?page=<?php echo $data['current_page'] - 1; ?><?php echo isset($_GET['status']) ? '&status=' . $_GET['status'] : ''; ?><?php echo isset($_GET['priority']) ? '&priority=' . $_GET['priority'] : ''; ?><?php echo isset($_GET['ticket_number']) ? '&ticket_number=' . $_GET['ticket_number'] : ''; ?>"
                    ...
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        ...
                        <div>
                            <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                                ...
                                if ($start > 1) {
                                    echo '<a href="' . URLROOT . '/tickets/agent?page=1' . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['priority']) ? '&priority=' . $_GET['priority'] : '') . (isset($_GET['ticket_number']) ? '&ticket_number=' . $_GET['ticket_number'] : '') . '" 
                                ...
                                for ($i = $start; $i <= $end; $i++) {
                                    if ($i == $data['current_page']) {
                                        ...
                                        echo '<a href="' . URLROOT . '/tickets/agent?page=' . $i . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['priority']) ? '&priority=' . $_GET['priority'] : '') . (isset($_GET['ticket_number']) ? '&ticket_number=' . $_GET['ticket_number'] : '') . '" 
                                            class="relative inline-flex items-center px-4 py-2 border border-gray-300 dark:border-zinc-600 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-600">
                                            ' . $i . '
                                          </a>';
                                    }
                                ...
                                if ($end < $data['total_pages']) {
                                    ...
                                    echo '<a href="' . URLROOT . '/tickets/agent?page=' . $data['total_pages'] . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['priority']) ? '&priority=' . $_GET['priority'] : '') . (isset($_GET['ticket_number']) ? '&ticket_number=' . $_GET['ticket_number'] : '') . '" 
                                        class="relative inline-flex items-center px-4 py-2 border border-gray-300 dark:border-zinc-600 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-600">
                                        ' . $data['total_pages'] . '
                                      </a>';
                                }
