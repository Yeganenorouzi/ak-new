                ...
                <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body p-4">
                            <form action="<?php echo URLROOT; ?>/receptions/agent" method="GET" class="filter-form">
                                ...
                                <div class="flex flex-wrap gap-3 items-center justify-between mt-4">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        ...
                                        <a href="<?php echo URLROOT; ?>/receptions/agent" class="inline-flex items-center px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                                    ...
                                    <!-- دکمه خروجی اکسل -->
                                    <a href="<?php echo URLROOT; ?>/export/exportReceptionsAgent" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
                        ...
                        <div class="flex items-center justify-between mt-4 px-4 py-3 bg-white dark:bg-zinc-800 border-t border-gray-200 dark:border-zinc-700 sm:px-6">
                            <div class="flex-1 flex justify-between sm:hidden">
                                ...
                                <a href="<?php echo URLROOT; ?>/receptions/agent?page=<?php echo $data['pagination']['current_page'] - 1; ?><?php echo !empty($_GET) ? '&' . http_build_query(array_diff_key($_GET, ['page' => ''])) : ''; ?>" 
                            ...
                            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                <div>
                                    <p class="text-sm text-gray-700 dark:text-gray-300">
                                        نمایش 
                                        <span class="font-medium"><?php echo ($data['pagination']['current_page'] - 1) * $data['pagination']['per_page'] + 1; ?></span>
                                        تا
                                        <span class="font-medium"><?php echo min($data['pagination']['current_page'] * $data['pagination']['per_page'], $data['pagination']['total']); ?></span>
                                        از
                                        <span class="font-medium"><?php echo $data['pagination']['total']; ?></span>
                                        نتیجه
                                    </p>
                                </div>
                                ...
                                <div>
                                    <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                                        ...
                                        if ($start > 1) {
                                            echo '<a href="' . URLROOT . '/receptions/agent?page=1' . (!empty($_GET) ? '&' . http_build_query(array_diff_key($_GET, ['page' => ''])) : '') . '" 
                                        ...
                                        for ($i = $start; $i <= $end; $i++) {
                                            if ($i == $data['pagination']['current_page']) {
                                                ...
                                                echo '<a href="' . URLROOT . '/receptions/agent?page=' . $i . (!empty($_GET) ? '&' . http_build_query(array_diff_key($_GET, ['page' => ''])) : '') . '" 
                                                        class="relative inline-flex items-center px-4 py-2 border border-gray-300 dark:border-zinc-600 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-600">
                                                        ' . $i . '
                                                      </a>';
                                            }
                                        ...
                                        if ($end < $data['pagination']['total_pages']) {
                                            ...
                                            echo '<a href="' . URLROOT . '/receptions/agent?page=' . $data['pagination']['total_pages'] . (!empty($_GET) ? '&' . http_build_query(array_diff_key($_GET, ['page' => ''])) : '') . '" 
                                                    class="relative inline-flex items-center px-4 py-2 border border-gray-300 dark:border-zinc-600 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-600">
