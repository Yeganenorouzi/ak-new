          ...
          <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 ltr:md:space-x-3 rtl:md:space-x-0">
              <li class="inline-flex items-center">
                <a href="<?php echo URLROOT; ?>/dashboard/agent" class="inline-flex items-center text-sm font-medium text-gray-800 hover:text-gray-900 dark:text-zinc-100 dark:hover:text-white">
                  داشبورد
                </a>
              </li>
              <li>
      ...
      <main class="w-3/4 p-8">
        ...
        <div class="grid grid-cols-4 gap-6 mb-8">
          <div class="bg-white rounded-lg shadow p-6 text-center">
            ...
            <p class="text-2xl font-bold text-blue-600 mt-2">150</p>
          </div>
          <div class="bg-white rounded-lg shadow p-6 text-center">
