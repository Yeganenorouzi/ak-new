  ...
  <div class="page-content dark:bg-zinc-700">
    <div class="container-fluid px-[0.625rem]">
      ...
      <main class="w-full p-8">
        ...
        <!-- Main grid container for card and table -->
        <div class="grid grid-cols-3 gap-6 mb-8">
          <!-- Left side - Single Card -->
          <div class="col-span-1">
            <div class="bg-white rounded-lg shadow p-4 text-center">
              <h3 class="text-sm font-semibold text-gray-700">تعداد کل پذیرش ها</h3>
              <p class="text-xl font-bold text-blue-600 mt-2"><?php echo $data['total_receptions_by_agent']; ?></p>
            </div>
          </div>
