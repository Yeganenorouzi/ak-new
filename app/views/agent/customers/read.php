            ...
            <div class="col-span-12">
                <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                    <div class="card-body pb-0">
                        ...
                        <!-- Search Form -->
                        <form action="<?php echo URLROOT; ?>/customers/agent" method="GET" class="mt-4">
                                    ...
                                    <ul class="flex list-style-none">
                                        ...
                                        <li
                                            ...
                                            <a class="page-link relative block py-2 px-4 border-0 bg-transparent outline-none transition-all duration-300 <?php echo (1 == $data['pagination']['current_page']) ? 'text-violet-500' : 'text-gray-500'; ?> hover:text-violet-500 hover:bg-gray-50/50 focus:shadow-none dark:text-zinc-100 dark:hover:bg-zinc-600"
                                                href="<?php echo URLROOT; ?>/customers/agent?page=1<?php echo !empty($_GET['search_name']) ? '&search_name=' . urlencode($_GET['search_name']) : ''; ?><?php echo !empty($_GET['search_codemelli']) ? '&search_codemelli=' . urlencode($_GET['search_codemelli']) : ''; ?><?php echo !empty($_GET['search_mobile']) ? '&search_mobile=' . urlencode($_GET['search_mobile']) : ''; ?>">1</a>
                                        </li>
                                        ...
                                        for ($i = $start; $i <= $end; $i++):
                                            ...
                                            <li
                                                ...
                                                <a class="page-link relative block py-2 px-4 border-0 bg-transparent outline-none transition-all duration-300 <?php echo ($i == $data['pagination']['current_page']) ? 'text-violet-500' : 'text-gray-500'; ?> hover:text-violet-500 hover:bg-gray-50/50 focus:shadow-none dark:text-zinc-100 dark:hover:bg-zinc-600"
                                                    href="<?php echo URLROOT; ?>/customers/agent?page=<?php echo $i; ?><?php echo !empty($_GET['search_name']) ? '&search_name=' . urlencode($_GET['search_name']) : ''; ?><?php echo !empty($_GET['search_codemelli']) ? '&search_codemelli=' . urlencode($_GET['search_codemelli']) : ''; ?><?php echo !empty($_GET['search_mobile']) ? '&search_mobile=' . urlencode($_GET['search_mobile']) : ''; ?>"><?php echo $i; ?></a>
                                            </li>
                                        <?php endfor; ?>
