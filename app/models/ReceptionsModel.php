...
class ReceptionsModel
{
   ...
   */
  public function getPaginatedReceptionsByAgent($page = 1, $perPage = 50)
  {
    if (!isset($_SESSION["id"])) {
      throw new Exception("User not logged in");
    }
   ...
   */
  public function getPaginatedFilteredReceptionsByAgent($filters, $page = 1, $perPage = 50)
  {
    if (!isset($_SESSION["id"])) {
      throw new Exception("User not logged in");
    }
  ...
  public function getPaginatedReceptions($page = 1, $perPage = 50)
  {
    try {
        $offset = ($page - 1) * $perPage;
  ...
  public function getPaginatedFilteredReceptions($filters, $page = 1, $perPage = 50)
  {
    try {
        $offset = ($page - 1) * $perPage;
